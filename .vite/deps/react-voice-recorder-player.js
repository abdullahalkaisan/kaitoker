...
// node_modules/react-voice-recorder-player/dist/react-voice-recorder-player.js
...
function Zr() {
  return ur || (ur = 1, function() {
    ...
    var T = false, o = false, $ = false, G = false, I = false, w;
...
` + W[oe].replace(" at new ", " at ");
        ...
        q = false, F.current = re, U(), Error.prepareStackTrace = z;
      }
    ...
    function xr(e, a, v, k, z) {
      {
        ...
        for (var Y in e)
          if (re(e, Y)) {
            ...
            W && !(W instanceof Error) && (Oe(z), c("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", k || "React class", v, Y, typeof W), Oe(null)), W instanceof Error && !(W.message in Je) && (Je[W.message] = true, Oe(z), c("Failed %s type: %s", v, W.message), Oe(null));
          }
      }
    }
    ...
    function Mr(e, a) {
      if (typeof e.ref == "string" && Se.current && a && Se.current.stateNode !== a) {
        ...
        Me[v] || (c('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', N(Se.current.type), e.ref), Me[v] = true);
      }
    }
    function jr(e, a) {
      {
        var v = function() {
          Qe || (Qe = true, c("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", a));
        };
        v.isReactWarning = true, Object.defineProperty(e, "key", {
          get: v,
          configurable: true
        });
      }
    ...
    function Dr(e, a) {
      {
        var v = function() {
          er || (er = true, c("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", a));
        };
        v.isReactWarning = true, Object.defineProperty(e, "ref", {
          get: v,
          configurable: true
        });
      }
...
Check the top-level render call using <` + v + ">.");
    ...
    function qr(e, a, v) {
      return ir(e, a, v, true);
    }
    function Wr(e, a, v) {
      return ir(e, a, v, false);
    }
    var Yr = Wr, Gr = qr;
    _e.Fragment = u, _e.jsx = Yr, _e.jsxs = Gr;
  }()), _e;
}
false ? We.exports = Xr() : We.exports = Zr();
var Cr = We.exports;
var Z = Cr.jsx;
var ye = Cr.jsxs;
var Ye = { exports: {} };
...
function Qr() {
  return fr || (fr = 1, function() {
    ...
    var o = s, $ = t, G = n, I = E, w = l, _ = b, H = u, ee = j, N = P, K = d, ne = p, Q = m, te = g, le = false;
    function ae(y) {
      return le || (le = true, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), i(y) || T(y) === s;
    }
    function i(y) {
      return T(y) === t;
    }
...
var dr;
function Er() {
  return dr || (dr = 1, false ? ke.exports = Kr() : ke.exports = Qr()), ke.exports;
}
var $e;
var pr;
function et() {
...
function tt() {
  ...
  return Ve = function(n, s) {
    ...
    function x(i) {
      ...
      var A = D.bind(null, false);
      return A.isRequired = D.bind(null, true), A;
    }
    function h(i) {
    ...
    function w(i) {
      if (!Array.isArray(i))
        return p("Invalid argument supplied to oneOfType, expected an instance of array."), E;
...
Valid keys: ` + JSON.stringify(Object.keys(i), null, "  ")
    ...
    function ne(i, C) {
      return i === "symbol" ? true : C ? C["@@toStringTag"] === "Symbol" || typeof Symbol == "function" && C instanceof Symbol : false;
    }
    function Q(i) {
      var C = typeof i;
...
var it = Ye.exports;
var Re = Jr(it);
var Tr = (0, import_react.createContext)({
  audioStatus: "",
  audioFile: void 0,
...
function st({ children: r }) {
  const [l, d] = (0, import_react.useState)(""), [u, m] = (0, import_react.useState)(), [p, E] = (0, import_react.useState)(), [n, s] = (0, import_react.useState)(false), S = {
    audioStatus: l,
    audioRecording: u,
  ...
  return Z(Tr.Provider, { value: S, children: r });
}
function Ee() {
  const r = (0, import_react.useContext)(Tr);
  if (r === void 0)
...
function ct({ userPropsValue: r, children: l }) {
  return Z(_r.Provider, { value: r, children: l });
}
function xe() {
  const r = (0, import_react.useContext)(_r);
  if (r === void 0)
...
var Ae = { solid: "rgb(54, 54, 54)", faded: "rgb(210, 209, 208)" };
var gt = (r, l, d) => {
...
var mt = 100;
function bt() {
  const { audioStatus: r = "", updateAudioRecording: l } = Ee(), { graphColor: d, graphShaded: u, rootElementId: m, onRecordingEnd: p } = xe(), [E, n] = (0, import_react.useState)(0), s = (0, import_react.useRef)(null), t = (0, import_react.useRef)({}), b = (0, import_react.useRef)(r);
  (0, import_react.useEffect)(() => {
    var R, x, h, c, f, T, o, $, G, I, w, _;
    b.current = r, r === "recording" && (((x = (R = t == null ? void 0 : t.current) == null ? void 0 : R.audioContext) == null ? void 0 : x.state) === "suspended" ? (t.current.audioContext.resume().then(P), (c = (h = t.current) == null ? void 0 : h.mediaRecorder) == null || c.resume()) : (T = (f = t == null ? void 0 : t.current) == null ? void 0 : f.audioContext) != null && T.state || navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(S)), r === "stopped" && (($ = (o = t == null ? void 0 : t.current) == null ? void 0 : o.mediaRecorder) == null || $.stop()), r === "paused_recording" && ((I = (G = t == null ? void 0 : t.current) == null ? void 0 : G.audioContext) == null || I.suspend(), (_ = (w = t == null ? void 0 : t.current) == null ? void 0 : w.mediaRecorder) == null || _.pause());
  ...
  return Z("div", { className: "voice-recorder_recordcontainer" });
}
var wt = 0.06;
function Ct() {
  const [r, l] = (0, import_react.useState)([]), { audioRecording: d, audioStatus: u, updateAudioStatus: m } = Ee(), { graphColor: p, graphShaded: E, rootElementId: n, onPlayEnd: s } = xe(), t = (0, import_react.useRef)(null), b = (0, import_react.useRef)(null), g = (0, import_react.useRef)(null), S = (0, import_react.useRef)(null), P = (0, import_react.useRef)(), { blob: j, duration: R = 0, graphData: x = [] } = d || {}, h = (0, import_react.useRef)(x);
  (0, import_react.useEffect)(() => {
  ...
  const c = (w) => {
    ...
    if (_.autoplay = true, _.readyState !== 4) {
  ...
  return ye("div", { className: "voice-recorder_playbackcontainer", children: [
    Z("audio", { ref: S, controls: true, id: "playback_audio", children: Z("track", { src: "captions.vtt", kind: "captions", srcLang: "en", label: "English" }) }),
    Z("div", { className: "voice-recorder_canvascontainer" })
  ] });
}
function Et() {
  const [r, l] = (0, import_react.useState)(false), {
    updateAudioRecording: d,
    updateAudioStatus: u,
    audioFile: m,
    setAudioFileProcessing: p
  } = Ee(), { rootElementId: E } = xe(), n = (0, import_react.useRef)(null), s = (0, import_react.useRef)({});
  (0, import_react.useEffect)(() => {
    const b = Fe(E, ["waveformgraph-record"], ".voice-recorder_recordcontainer");
    return b && (n.current = b[0]), p(true), t(), () => p(false);
  }, []);
  const t = async () => {
    if (!m)
      return;
  ...
  }, [r]), Z("div", { className: "voice-recorder_recordcontainer" });
}
function St() {
  const { audioStatus: r } = Ee(), { waveContainerStyle: l } = xe(), [d, u] = (0, import_react.useState)("");
  return (0, import_react.useEffect)(() => {
    u(r === "playing" || r === "playing_requested" || r === "paused_playing" || r === "stopped" ? "playing" : r === "processing" ? "prerecord" : "recording");
  }, [r]), ye("div", { className: "voice-recorder_waveformcontainer", style: l, children: [
    d === "playing" ? Z(Ct, {}) : null,
    d === "prerecord" ? Z(Et, {}) : null,
    d === "recording" ? Z(bt, {}) : null
  ] });
}
var Tt = (r) => B.createElement("svg", { width: "100px", height: "100px", viewBox: "-40 -25 600 600", xmlns: "http://www.w3.org/2000/svg", fill: "#000000", ...r }, B.createElement("g", { id: "SVGRepo_bgCarrier", strokeWidth: 0 }), B.createElement("g", { id: "SVGRepo_tracerCarrier", strokeLinecap: "round", strokeLinejoin: "round" }), B.createElement("g", { id: "SVGRepo_iconCarrier" }, B.createElement("path", { fill: "#000000", d: "M120.16 45A20.162 20.162 0 0 0 100 65.16v381.68A20.162 20.162 0 0 0 120.16 467h65.68A20.162 20.162 0 0 0 206 446.84V65.16A20.162 20.162 0 0 0 185.84 45h-65.68zm206 0A20.162 20.162 0 0 0 306 65.16v381.68A20.162 20.162 0 0 0 326.16 467h65.68A20.162 20.162 0 0 0 412 446.84V65.16A20.162 20.162 0 0 0 391.84 45h-65.68z" })));
var _t = (r) => B.createElement("svg", { fill: "#000000", height: "100px", width: "100px", id: "Capa_1", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", viewBox: "-3 -2 20.804 20.804", xmlSpace: "preserve", ...r }, B.createElement("g", { id: "SVGRepo_bgCarrier", strokeWidth: 0 }), B.createElement("g", { id: "SVGRepo_tracerCarrier", strokeLinecap: "round", strokeLinejoin: "round" }), B.createElement("g", { id: "SVGRepo_iconCarrier" }, B.createElement("g", null, B.createElement("g", { id: "c98_play" }, B.createElement("path", { d: "M2.067,0.043C2.21-0.028,2.372-0.008,2.493,0.085l13.312,8.503c0.094,0.078,0.154,0.191,0.154,0.313 c0,0.12-0.061,0.237-0.154,0.314L2.492,17.717c-0.07,0.057-0.162,0.087-0.25,0.087l-0.176-0.04 c-0.136-0.065-0.222-0.207-0.222-0.361V0.402C1.844,0.25,1.93,0.107,2.067,0.043z" })), B.createElement("g", { id: "Capa_1_78_" }))));
var Rt = (r) => B.createElement("svg", { className: "voice-recorder-icon", width: "100px", height: "100px", viewBox: "0 0 512 512", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", fill: "#000000", ...r }, B.createElement("g", { id: "SVGRepo_bgCarrier", strokeWidth: 0 }), B.createElement("g", { id: "SVGRepo_tracerCarrier", strokeLinecap: "round", strokeLinejoin: "round" }), B.createElement("g", { id: "SVGRepo_iconCarrier" }, B.createElement("title", null, "microphone-filled"), B.createElement("g", { id: "Page-1", stroke: "none", strokeWidth: 1, fill: "none", fillRule: "evenodd" }, B.createElement("g", { id: "icon", fill: "#000000", transform: "translate(85.333333, 42.666667)" }, B.createElement("path", { d: "M42.6666667,170.666667 C42.6666667,183.68 47.1466667,298.666667 170.666667,298.666667 C294.186667,298.666667 298.666667,183.68 298.666667,170.666667 L298.666667,170.666667 L341.333333,170.666667 C341.333333,226.346667 309.333333,328.96 192,341.333333 L192,341.333333 L192,426.666667 L149.333333,426.666667 L149.333333,341.333333 C32,328.96 1.42108547e-14,226.346667 1.42108547e-14,170.666667 L1.42108547e-14,170.666667 Z M170.666667,7.10542736e-15 C211.903928,7.10542736e-15 245.333333,33.4294053 245.333333,74.6666667 L245.333333,74.6666667 L245.333333,181.333333 C245.333333,222.570595 211.903928,256 170.666667,256 C150.863835,256 131.872077,248.133356 117.86936,234.13064 C103.866644,220.127923 96,201.136165 96,181.333333 L96,181.333333 L96,74.6666667 C96,33.4294053 129.429405,7.10542736e-15 170.666667,7.10542736e-15 Z", id: "voice" })))));
var xt = (r) => B.createElement("svg", { fill: "#000000", height: "100px", width: "100px", id: "Layer_1", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", viewBox: "-35 -35 590 590", enableBackground: "new 0 0 512 512", xmlSpace: "preserve", ...r }, B.createElement("g", { id: "SVGRepo_bgCarrier", strokeWidth: 0 }), B.createElement("g", { id: "SVGRepo_tracerCarrier", strokeLinecap: "round", strokeLinejoin: "round" }), B.createElement("g", { id: "SVGRepo_iconCarrier" }, B.createElement("path", { d: "M512,192V21.3l-64.9,64.9C400.3,33.4,332.2,0,256,0C114.6,0,0,114.6,0,256s114.6,256,256,256c70.7,0,134.7-28.6,181-75 l-45.3-45.2C357,426.5,309,448,256,448c-106,0-192-85.9-192-192c0-106.1,86-192,192-192c58.5,0,110.4,26.5,145.5,67.8L341.3,192H512 z" })));
var Pt = (r) => B.createElement("svg", { fill: "#000000", viewBox: "-15 -15 525 525", xmlSpace: "preserve", width: "70px", height: "70px", id: "Capa_1", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", ...r }, B.createElement("g", { id: "SVGRepo_bgCarrier", strokeWidth: 0 }), B.createElement("g", { id: "SVGRepo_tracerCarrier", strokeLinecap: "round", strokeLinejoin: "round" }), B.createElement("g", { id: "SVGRepo_iconCarrier" }, B.createElement("g", null, B.createElement("polygon", { points: "360.352,232.334 324.344,203.803 267.969,274.968 267.969,0 222.031,0 222.031,274.968 165.656,203.803 129.648,232.334 245,377.923 " }), B.createElement("rect", { x: 58.02, y: 444.063, width: 373.96, height: 45.938 }))));
var Ot = (r) => B.createElement("svg", { width: "100px", height: "100px", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", id: "upload", ...r }, B.createElement("path", { d: "M8.71,7.71,11,5.41V15a1,1,0,0,0,2,0V5.41l2.29,2.3a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42l-4-4a1,1,0,0,0-.33-.21,1,1,0,0,0-.76,0,1,1,0,0,0-.33.21l-4,4A1,1,0,1,0,8.71,7.71ZM21,12a1,1,0,0,0-1,1v6a1,1,0,0,1-1,1H5a1,1,0,0,1-1-1V13a1,1,0,0,0-2,0v6a3,3,0,0,0,3,3H19a3,3,0,0,0,3-3V13A1,1,0,0,0,21,12Z" }));
var kt = (r) => B.createElement("svg", { width: "100px", height: "100px", viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", ...r }, B.createElement("path", { d: "M7.706 0.290 C 7.484 0.362,7.356 0.490,7.294 0.699 C 7.259 0.816,7.253 1.088,7.253 2.508 C 7.253 4.389,7.251 4.365,7.443 4.557 C 7.700 4.813,8.300 4.813,8.557 4.557 C 8.749 4.365,8.747 4.389,8.747 2.508 C 8.747 0.688,8.744 0.656,8.596 0.480 C 8.472 0.333,8.339 0.284,8.040 0.276 C 7.893 0.272,7.743 0.278,7.706 0.290 M2.753 2.266 C 2.595 2.338,2.362 2.566,2.281 2.728 C 2.197 2.897,2.193 3.085,2.269 3.253 C 2.343 3.418,4.667 5.750,4.850 5.843 C 5.109 5.976,5.375 5.911,5.643 5.649 C 5.907 5.391,5.977 5.111,5.843 4.850 C 5.750 4.667,3.418 2.343,3.253 2.269 C 3.101 2.200,2.901 2.199,2.753 2.266 M12.853 2.282 C 12.730 2.339,12.520 2.536,11.518 3.541 C 10.597 4.464,10.316 4.762,10.271 4.860 C 10.195 5.025,10.196 5.216,10.272 5.378 C 10.342 5.528,10.572 5.764,10.727 5.845 C 10.884 5.927,11.117 5.926,11.280 5.843 C 11.447 5.757,13.757 3.447,13.843 3.280 C 13.926 3.118,13.927 2.884,13.846 2.729 C 13.764 2.572,13.552 2.364,13.392 2.283 C 13.213 2.192,13.048 2.192,12.853 2.282 M0.699 7.292 C 0.404 7.385,0.258 7.620,0.258 7.999 C 0.259 8.386,0.403 8.618,0.698 8.706 C 0.816 8.741,1.079 8.747,2.508 8.747 C 3.997 8.747,4.196 8.742,4.318 8.702 C 4.498 8.644,4.644 8.498,4.702 8.318 C 4.788 8.053,4.745 7.677,4.608 7.491 C 4.578 7.451,4.492 7.384,4.417 7.343 L 4.280 7.267 2.547 7.261 C 1.152 7.257,0.791 7.263,0.699 7.292 M11.745 7.278 C 11.622 7.308,11.452 7.411,11.392 7.492 C 11.255 7.677,11.212 8.053,11.298 8.318 C 11.356 8.498,11.502 8.644,11.682 8.702 C 11.804 8.742,12.003 8.747,13.492 8.747 C 14.921 8.747,15.184 8.741,15.302 8.706 C 15.597 8.618,15.741 8.386,15.742 7.999 C 15.742 7.614,15.595 7.383,15.290 7.291 C 15.187 7.260,14.864 7.254,13.496 7.256 C 12.578 7.258,11.790 7.268,11.745 7.278 M4.853 10.282 C 4.730 10.339,4.520 10.536,3.518 11.541 C 2.597 12.464,2.316 12.762,2.271 12.860 C 2.195 13.025,2.196 13.216,2.272 13.378 C 2.342 13.528,2.572 13.764,2.727 13.845 C 2.884 13.927,3.117 13.926,3.280 13.843 C 3.447 13.757,5.757 11.447,5.843 11.280 C 5.926 11.118,5.927 10.884,5.846 10.729 C 5.764 10.572,5.552 10.364,5.392 10.283 C 5.213 10.192,5.048 10.192,4.853 10.282 M10.753 10.266 C 10.595 10.338,10.362 10.566,10.281 10.728 C 10.197 10.897,10.193 11.085,10.269 11.253 C 10.343 11.418,12.667 13.750,12.850 13.843 C 13.109 13.976,13.375 13.911,13.643 13.649 C 13.907 13.391,13.977 13.111,13.843 12.850 C 13.750 12.667,11.418 10.343,11.253 10.269 C 11.101 10.200,10.901 10.199,10.753 10.266 M7.745 11.277 C 7.620 11.309,7.451 11.412,7.392 11.492 C 7.254 11.678,7.253 11.691,7.253 13.489 C 7.253 14.921,7.259 15.184,7.294 15.302 C 7.382 15.597,7.615 15.741,8.000 15.741 C 8.385 15.741,8.618 15.597,8.706 15.302 C 8.768 15.090,8.767 11.875,8.704 11.690 C 8.644 11.514,8.575 11.430,8.420 11.346 C 8.310 11.286,8.246 11.271,8.057 11.264 C 7.930 11.259,7.790 11.265,7.745 11.277 ", stroke: "none", fillRule: "evenodd", fill: "#000000" }));
var Rr = { exports: {} };
(function(r, l) {
  (function(d, u) {
    r.exports = u(import_react.default);
    ...
    p.d = (n, s) => {
      for (var t in s)
        p.o(s, t) && !p.o(n, t) && Object.defineProperty(n, t, { enumerable: true, get: s[t] });
    ...
    return (() => {
      ...
      function P() {
        let { expiryTimestamp: h, onExpire: c, autoStart: f = true } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        const [T, o] = (0, n.useState)(h), [$, G] = (0, n.useState)(t.getSecondsFromExpiry(T)), [I, w] = (0, n.useState)(f), [_, H] = (0, n.useState)(f), [ee, N] = (0, n.useState)(S(T)), K = (0, n.useCallback)(() => {
          ...
          _ ? (G(t.getSecondsFromExpiry(T)), w(true)) : te();
        }, [T, _, te]);
        return b(() => {
          ee !== g && N(g);
      ...
      function j() {
        ...
        const [f, T] = (0, n.useState)(t.getSecondsFromExpiry(c, true) || 0), [o, $] = (0, n.useState)(/* @__PURE__ */ new Date()), [G, I] = (0, n.useState)(f + t.getSecondsFromPrevTime(o || 0, true)), [w, _] = (0, n.useState)(h);
        b(() => {
          I(f + t.getSecondsFromPrevTime(o, true));
        }, w ? 1e3 : null);
        const H = (0, n.useCallback)(() => {
          const K = /* @__PURE__ */ new Date();
          $(K), _(true), I(f + t.getSecondsFromPrevTime(K, true));
          ...
          const Q = t.getSecondsFromExpiry(K, true) || 0, te = /* @__PURE__ */ new Date();
          $(te), T(Q), _(ne), I(Q + t.getSecondsFromPrevTime(te, true));
        }, []);
...
var At = Rr.exports;
var Ft = (r) => B.createElement("svg", { width: "100px", height: "100px", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", ...r }, B.createElement("g", { id: "SVGRepo_bgCarrier", strokeWidth: 0 }), B.createElement("g", { id: "SVGRepo_tracerCarrier", strokeLinecap: "round", strokeLinejoin: "round" }), B.createElement("g", { id: "SVGRepo_iconCarrier" }, B.createElement("path", { d: "M5 3C3.89543 3 3 3.89543 3 5V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V5C21 3.89543 20.1046 3 19 3H5Z", fill: "#000000" })));
function It() {
  const { audioStatus: r } = Ee(), {
    ...
    pause: p,
    reset: E
  } = At.useStopwatch({ autoStart: false });
  (0, import_react.useEffect)(() => {
    r === "recording" ? m() : r === "paused_playing" || r === "paused_recording" || r === "stopped" ? p() : E();
  }, [r]);
  const n = (s) => s.toLocaleString("en-US", { minimumIntegerDigits: 2, useGrouping: false });
  return ye("div", { className: `voice-recorder_stopcontainer ${r === "paused_recording" ? "voice-recorder_showblinking" : ""}`, children: [
    Z("div", { className: "voice-recorder_control", children: Z(Ft, {}) }),
    ye("div", { className: "voice-recorder_stopwatch", children: [
      u ? Z("span", { children: u }) : null,
      Z("span", { children: n(d) }),
      ":",
      Z("span", { children: n(l) })
    ] })
...
function Mt() {
  const r = (0, import_react.useRef)(null), l = (0, import_react.useRef)(null), { audioStatus: d, updateAudioStatus: u, audioRecording: m, convertAudioFile: p } = Ee(), {
    controllerContainerStyle: E,
    controllerStyle: n,
    downloadable: s = true,
    uploadAudioFile: t = true,
    onAudioDownload: b,
    onRecordingStart: g,
    onPlayStart: S,
    onRecordingPause: P,
    onPlayPause: j,
    rootElementId: R
  } = xe(), [x, h] = (0, import_react.useState)(ge), c = ({ svg: I, disabled: w, status: _, onClick: H, applyCircularStyles: ee = true, display: N = true, rotate: K = false }) => {
    if (!_ || !N)
      return null;
    let ne = `${ee ? "voice-recorder_control" : ""} voice-recorder_controlgeneric`;
    return ne += `${K ? " voice-recorder_rotate" : ""}`, Z("button", { onClick: H, disabled: w, className: ne, style: n, children: I });
  }, f = (I) => () => {
    u(I);
  }, T = () => {
    navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(f("recording")).catch(() => alert("Please allow acccess to your microphone to continue."));
  }, o = () => {
    const { blob: I = "" } = m || {};
    if (!I || !r.current)
      return null;
  ...
  return (0, import_react.useEffect)(() => {
  ...
  }, [d]), ye("div", { className: "voice-recorder_controlscontainer", style: E, children: [
    ye("div", { className: "voice-recorder_controls", children: [
      c({
        svg: Z(Rt, {}),
      ...
      ye("div", { className: "voice-recorder_download", children: [
        c({
          svg: Z(Pt, {}),
          disabled: false,
          status: x.showRedoBtn,
    ...
    Z("input", { ref: l, type: "file", style: { display: "none" }, accept: "audio/*" }),
    Z("a", { ref: r, download: true, style: { display: "none" }, className: "voice-recorder_downloadfile" })
  ] });
}
var jt = (r) => {
  const {
    ...
    width: u,
    ...m
  } = r, p = (0, import_react.useId)(), E = {
    ...l,
    height: d,
    width: u
  }, n = `voice-recorder-${p}`;
  return Z(st, { children: Z(ct, { userPropsValue: { ...m, rootElementId: n }, children: ye("div", { id: n, className: "voice-recorder_maincontainer", style: E, children: [
    Z(St, {}),
    Z(Mt, {})
  ] }) }) });
};
...
react-voice-recorder-player/dist/react-voice-recorder-player.js:
  (**
   * @license React
...
react-voice-recorder-player/dist/react-voice-recorder-player.js:
  ...
  *)
*/
//# sourceMappingURL=react-voice-recorder-player.js.map
